...
export const AudioClipSchema = BaseClipSchema.extend({
    ...
    audio_generation_params: AudioGenerationParamsSchema.nullable().describe("Text-to-speech parameters, null if audio is pre-generated"),
    audio_task_id: z.string().nullable().describe("ID of the audio generation task, null if not yet generated"),
    audio_asset_id: z.string().nullable().describe("ID of the generated audio asset, null if not yet generated")
}).describe("Audio clip with text-to-speech generation capabilities");
export type AudioClip = z.infer<typeof AudioClipSchema>;

export const ImageGenerationTypeSchema = z.enum(["text_to_image", "image_to_image"]).describe("Type of image generation: from text prompt or from reference image");
...
export const VisualClipSchema = BaseClipSchema.extend({
    ...
    image_generation_params: z.union([TextToImageGenerationParamsSchema, ImageToImageGenerationParamsSchema]).nullable().describe("Image generation parameters, null if using pre-generated image"),
    image_task_id: z.string().nullable().describe("ID of the image generation task, null if not yet generated"),
    image_asset_id: z.string().nullable().describe("ID of the generated image asset, null if not yet generated"),
    video_generation_params: VideoGenerationParamsSchema.nullable().describe("Video generation parameters, null if using pre-generated video"),
    video_task_id: z.string().nullable().describe("ID of the video generation task, null if not yet generated"),
    video_asset_id: z.string().nullable().describe("ID of the generated video asset, null if not yet generated")
